...
def get_schedule_for_season():
    ...
    for race in races:
        item = {
            ...
            "type": "NORMAL" if int(race["round"]) not in (4, 11, 21) else "SPRINT", #Imola, Redbull ring, Brazil
            "quali_start": "TBC",
            "sprint_start": "TBC",
        }
        out.append(item)
...
def get_utc_from_local(date, gmt_offset):
    if "TBC" in date:
        ...
        date_local = datetime.fromisoformat(date + gmt_offset) #"'2022-03-19T18:00:00+03:00'"
